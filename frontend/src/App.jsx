        ...
        <section className={`content-pane ${(selectedFeatures.length > 0 || selectedPainPoints.length > 0) && activeTab !== 'prd' ? 'has-action-dock' : ''}`}>
          {selectedTranscript ? (
            <>
              ...
              <div className="workspace-header-bar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', padding: '10px 14px', background: 'rgba(255,255,255,0.85)', border: '1px solid rgba(0,0,0,0.07)', borderRadius: '12px' }}>
                <div>
